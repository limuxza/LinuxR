...
function Linux:Notify(config)
    ...
    local notificationWidth = isMobile and 280 or 350
    local notificationHeight = config.SubContent and 85 or 65
    local startPosX = isMobile and 15 or 25
    ...
    local Notification = Linux.Instance("Frame", {
        ...
        Position = UDim2.new(1, 10, 1, -notificationHeight - 15),
        ZIndex = 100
    })
    ...
    local NotificationGradient = Linux.Instance("UIGradient", {
        Parent = Notification,
    ...
    TweenService:Create(Notification, tweenInfo, {Position = UDim2.new(0, startPosX, 1, -notificationHeight - 15)}):Play()
    ...
    if config.Duration then
        ...
        task.delay(config.Duration, function()
            TweenService:Create(Notification, tweenInfo, {Position = UDim2.new(1, 10, 1, -notificationHeight - 15)}):Play()
            task.wait(0.4)
...
function Linux.Create(config)
    ...
    local ToggleButton = Linux.Instance("ImageButton", {
        ...
        Position = UDim2.new(0, 25, 0.5, -27.5),
    ...
    ToggleButton.InputChanged:Connect(function(input)
        if isDragging and (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then
            ...
            if math.abs(delta.X) > 5 or math.abs(delta.Y) > 5 then
                hasMoved = true
                local newX = math.clamp(startPos.X.Offset + delta.X, 0, ToggleUI.AbsoluteSize.X - 55)
                local newY = math.clamp(startPos.Y.Offset + delta.Y, 0, ToggleUI.AbsoluteSize.Y - 55)
    ...
    local isMobile = InputService.TouchEnabled and not InputService.KeyboardEnabled
    local uiSize = isMobile and (config.SizeMobile or UDim2.fromOffset(320, 520)) or (config.SizePC or UDim2.fromOffset(580, 380))
    ...
    local openingTween = TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out)
    ...
    local TabsBar = Linux.Instance("Frame", {
        ...
        Position = UDim2.new(0, 0, 0, 35),
        Size = UDim2.new(0, config.TabWidth or 140, 1, -35),
        ZIndex = 2,
        BorderSizePixel = 0
    })
    
    local TabsBarGradient = Linux.Instance("UIGradient", {
        Parent = TabsBar,
        Color = ColorSequence.new{
            ColorSequenceKeypoint.new(0, Color3.fromRGB(50, 50, 100)),
            ColorSequenceKeypoint.new(1, Color3.fromRGB(150, 50, 50))
    ...
    local SearchFrameGradient = Linux.Instance("UIGradient", {
        Parent = SearchFrame,
        Color = ColorSequence.new{
            ColorSequenceKeypoint.new(0, Color3.fromRGB(50, 50, 100)),
            ColorSequenceKeypoint.new(1, Color3.fromRGB(150, 50, 50))
    ...
    local Content = Linux.Instance("Frame", {
        ...
        BackgroundTransparency = 0,
        Position = UDim2.new(0, config.TabWidth or 140, 0, 35),
        Size = UDim2.new(1, -(config.TabWidth or 140), 1, -35),
        ZIndex = 1,
        BorderSizePixel = 0
    })
    ...
    local minimizedSize = UDim2.new(0, uiSize.X.Offset, 0, 35)
    
    MinimizeButton.MouseEnter:Connect(function()
        TweenService:Create(MinimizeButton, TweenInfo.new(0.2), {ImageTransparency = 0.3}):Play()
    end)
    
    MinimizeButton.MouseLeave:Connect(function()
        TweenService:Create(MinimizeButton, TweenInfo.new(0.2), {ImageTransparency = 0}):Play()
    end)
    ...
    MinimizeButton.MouseButton1Click:Connect(function()
        ...
        if isMinimized then
            TweenService:Create(Main, TweenInfo.new(0.3, Enum.EasingStyle.Quart), {Size = minimizedSize}):Play()
            Content.Visible = false
            TabsBar.Visible = false
            TopBarLine.Visible = false
            MinimizeButton.Image = "rbxassetid://10734886496"
        else
            TweenService:Create(Main, TweenInfo.new(0.3, Enum.EasingStyle.Quart), {Size = originalSize}):Play()
                ...
                for _, element in pairs(Tabs[tabIndex].Elements) do
                    if element.Type == "Slider" then
                        ...
                        if fillBar then
                            ...
                            local tween = TweenInfo.new(0.4, Enum.EasingStyle.Quart, Enum.EasingDirection.Out)
    ...
    local function AnimateTabTransition(newTabContent)
        spawn(function()
            local fadeOut = TweenInfo.new(0.2, Enum.EasingStyle.Quart, Enum.EasingDirection.Out)
            TweenService:Create(Content, fadeOut, {
                BackgroundTransparency = 0.3,
                Size = UDim2.new(1, -(config.TabWidth or 140) - 15, 1, -35)
            }):Play()
    ...
    function LinuxLib.Tab(config)
        ...
        local textOffset = config.Icon and config.Enabled and 38 or 18
        ...
        local TitleFrameGradient = Linux.Instance("UIGradient", {
            Parent = TitleFrame,
            Color = ColorSequence.new{
                ColorSequenceKeypoint.new(0, Color3.fromRGB(50, 50, 100)),
                ColorSequenceKeypoint.new(1, Color3.fromRGB(150, 50, 50))
        ...
        local EmptyText = Linux.Instance("TextLabel", {
            ...
            Position = UDim2.new(0, 25, 0.5, 35),
            Font = Enum.Font.SourceSansSemibold,
        ...
        local function SelectTab()
            ...
            TabText.TextColor3 = Color3.fromRGB(70, 70, 70)
            ...
            if TabIcon then
                TabIcon.ImageColor3 = Color3.fromRGB(70, 70, 70)
            end
        ...
        function TabElements.Button(config)
            ...
            if lastWasDropdown then
                ...
                ContainerListLayout.Padding = UDim.new(0, 2)
            end
            ...
            local BtnFrameGradient = Linux.Instance("UIGradient", {
                Parent = BtnFrame,
                Color = ColorSequence.new{
                    ColorSequenceKeypoint.new(0, Color3.fromRGB(50, 50, 100)),
                    ColorSequenceKeypoint.new(1, Color3.fromRGB(150, 50, 50))
            ...
            local Btn = Linux.Instance("TextButton", {
                Parent = BtnFrame,
                BackgroundTransparency = 1,
                Size = UDim2.new(1, 0, hasDescription and 0.65 or 1, 0),
                Position = UDim2.new(0, 0, 0, 0),
                Font = Enum.Font.SourceSansSemibold,
                Text = config.Name,
                TextColor3 = Color3.fromRGB(255, 255, 255),
            ...
            Btn.MouseEnter:Connect(function()
                TweenService:Create(BtnFrame, TweenInfo.new(0.2), {BackgroundTransparency = 0.1}):Play()
            end)
            ...
            Btn.MouseButton1Down:Connect(function()
                TweenService:Create(BtnFrame, TweenInfo.new(0.1), {Size = UDim2.new(1, -12, 0, frameHeight - 2)}):Play()
            end)
            
            Btn.MouseButton1Up:Connect(function()
                TweenService:Create(BtnFrame, TweenInfo.new(0.1), {Size = UDim2.new(1, -10, 0, frameHeight)}):Play()
            end)
        ...
        function TabElements.Toggle(config)
            ...
            local ToggleFrameGradient = Linux.Instance("UIGradient", {
                Parent = Toggle,
                Color = ColorSequence.new{
                    ColorSequenceKeypoint.new(0, Color3.fromRGB(50, 50, 100)),
                    ColorSequenceKeypoint.new(1, Color3.fromRGB(150, 50, 50))
            ...
            local ToggleText = Linux.Instance("TextLabel", {
                Parent = Toggle,
                BackgroundTransparency = 1,
                Size = UDim2.new(1, -70, hasDescription and 0.5 or 1, 0),
                Position = UDim2.new(0, 15, 0, 0),
                Font = Enum.Font.SourceSansSemibold,
                Text = config.Name,
                TextColor3 = Color3.fromRGB(255, 255, 255),
            ...
            local function UpdateToggle(thisToggle)
                ...
                if thisTrack and thisKnob then
                    ...
                    if currentState then
                        TweenService:Create(thisTrack, tween, {BackgroundColor3 = Color3.fromRGB(100, 200, 100)}):Play()
                        TweenService:Create(thisKnob, tween, {Position = UDim2.new(0, 22, 0.5, -9)}):Play()
                    else
                        TweenService:Create(thisTrack, tween, {BackgroundColor3 = Color3.fromRGB(200, 200, 205)}):Play()
                        TweenService:Create(thisKnob, tween, {Position = UDim2.new(0, 2, 0.5, -9)}):Play()
                    end
                end
        ...
        function TabElements.Dropdown(config)
            ...
            local DropdownFrameGradient = Linux.Instance("UIGradient", {
                Parent = Dropdown,
                Color = ColorSequence.new{
                    ColorSequenceKeypoint.new(0, Color3.fromRGB(50, 50, 100)),
                    ColorSequenceKeypoint.new(1, Color3.fromRGB(150, 50, 50))
            ...
            local function FormatDisplayText(value)
                if typeof(value) == "table" then
                    if #value > 0 then
                        ...
                        return displayText:sub(1, 25) .. (#displayText > 25 and "..." or "")
                    else
                        return "None"
                    end
                else
            ...
            local Selected = Linux.Instance("TextLabel", {
                Parent = DropdownButton,
                BackgroundTransparency = 1,
                Size = UDim2.new(0.3, -25, hasDescription and 0.5 or 1, 0),
            ...
            local function UpdateDropSize()
                ...
                if IsOpen then
                    ...
                    TweenService:Create(DropFrame, tween, {Size = UDim2.new(1, -10, 0, finalHeight)}):Play()
                    if #Options > 0 then
                        TweenService:Create(Arrow, tween, {Rotation = 90}):Play()
                    end
                else
                    TweenService:Create(DropFrame, tween, {Size = UDim2.new(1, -10, 0, 0)}):Play()
                    if #Options > 0 then
        ...
        function TabElements.Slider(config)
            ...
            local hasDescription = config.Description and config.Description ~= ""
            local frameHeight = hasDescription and 64 or 48
            ...
            local SliderFrameGradient = Linux.Instance("UIGradient", {
                Parent = Slider,
                Color = ColorSequence.new{
                    ColorSequenceKeypoint.new(0, Color3.fromRGB(50, 50, 100)),
                    ColorSequenceKeypoint.new(1, Color3.fromRGB(150, 50, 50))
            ...
            local SliderBar = Linux.Instance("Frame", {
                ...
                Position = UDim2.new(0, 15, 0, hasDescription and 46 or 30),
                ZIndex = 2,
                BorderSizePixel = 0,
                Name = "Bar"
            })
        ...
        function TabElements.Input(config)
            ...
            local InputFrameGradient = Linux.Instance("UIGradient", {
                Parent = Input,
                Color = ColorSequence.new{
                    ColorSequenceKeypoint.new(0, Color3.fromRGB(50, 50, 100)),
                    ColorSequenceKeypoint.new(1, Color3.fromRGB(150, 50, 50))
            ...
            local TextBoxFrame = Linux.Instance("Frame", {
                ...
                BackgroundTransparency = 0.2,
                BorderSizePixel = 0,
                Size = UDim2.new(0.3, -40, 0, 28),
                Position = UDim2.new(0.7, -25, 0.5, -14),
                ZIndex = 3
            })
        ...
        function TabElements.Label(config)
            ...
            local LabelFrameGradient = Linux.Instance("UIGradient", {
                Parent = LabelFrame,
                Color = ColorSequence.new{
                    ColorSequenceKeypoint.new(0, Color3.fromRGB(50, 50, 100)),
                    ColorSequenceKeypoint.new(1, Color3.fromRGB(150, 50, 50))
        ...
        function TabElements.Section(config)
            ...
            if config.Icon then
                SectionIcon = Linux.Instance("ImageLabel", {
                    ...
                    Image = config.Icon,
                    ImageColor3 = config.TextColor or Color3.fromRGB(70, 70, 70),
                    ZIndex = 2
                })
                iconOffset = 28
            end
            ...
            local SectionLabel = Linux.Instance("TextLabel", {
                Parent = Section,
                BackgroundTransparency = 1,
                Size = UDim2.new(1, -25 - iconOffset, 1, 0),
                Position = UDim2.new(0, iconOffset, 0, 0),
                Font = Enum.Font.SourceSansSemibold,
                Text = config.Name,
                TextColor3 = config.TextColor or Color3.fromRGB(70, 70, 70),
                TextSize = 20,
                TextXAlignment = Enum.TextXAlignment.Left,
                TextYAlignment = Enum.TextYAlignment.Center,
                ZIndex = 2
        ...
        function TabElements.Paragraph(config)
            ...
            local ParagraphFrameGradient = Linux.Instance("UIGradient", {
    ...
    task.spawn(function()
        ...
        if DefaultTab and Tabs[DefaultTab] then
            ...
            defaultTab.Text.TextColor3 = Color3.fromRGB(70, 70, 70)
            ...
            if defaultTab.Icon then
                defaultTab.Icon.ImageColor3 = Color3.fromRGB(70, 70, 70)
            end
        ...
        elseif tabOrder > 0 then
            ...
            if firstTab then
                ...
                firstTab.Text.TextColor3 = Color3.fromRGB(70, 70, 70)
                ...
                if firstTab.Icon then
                    firstTab.Icon.ImageColor3 = Color3.fromRGB(70, 70, 70)
                end
